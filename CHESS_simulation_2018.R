...
study_pop_ag[date==start , pr_treated:= exp(0.009*age_2018+0.009*imd+0.009*cvd+0.009*dep+0.005*cum_out*0+0.09*outcome1-6)
          /(1+
              exp(0.009*age_2018+0.009*imd+0.009*cvd+0.009*dep+0.005*cum_out*0+0.09*outcome1-6)
          ), by=.(plac_date)]
}
